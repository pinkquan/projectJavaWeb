...
PrintWriter out = response.getWriter();
        ...
        for (ProductObject itemObject : productList1) {
            ...
            out.append("<a href=\"#\" class=\"add-to-cart-btn\" title=\"Thêm vào giỏ\">");
            out.append("<i class=\"fa-solid fa-cart-arrow-down\"></i>");
            out.append("</a>");
            out.append("<a href=\"ProductDetail?id=" + itemObject.getProductId() + "\" title=\"Xem chi tiết\"><i class=\"fa-solid fa-circle-info\"></i></a>");
            out.append("</div>");
            out.append("</div>");
            out.append("</div>");
            out.append("</div>");
     ...
     // Lay danh sach Product tu co so du lieu
		...
		out.append("              <div class=\"pic\"><img src=\"/MyWeb/img/testimonials/viet.jpg\" class=\"img-fluid\" alt=\"\"></div>");
		...
		out.append("              <input type=\"text\" name=\"name\" class=\"form-control\" value=\"\" id=\"name\" placeholder=\"Họ và tên\" readonly style=\"background-color: #f5f5f5;\">");
		out.append("            </div>");
//		out.append("            <div class=\"col-lg-4 col-md-6\">");
...
//		out.append("            </div>");
		...
		out.append("	  				<option value=\"DV3\"selected>Tiệc cưới</option>");
		out.append("	  				<option value=\"DV2\">Tiệc tại gia</option>");
		out.append("	  				<option value=\"DV1\">Tiệc sinh nhật</option>");
		out.append("				</select>");
		out.append("            </div>");
		out.append("            <div class=\"col-lg-4 col-md-6\">");
